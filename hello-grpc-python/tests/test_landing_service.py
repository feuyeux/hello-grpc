...
from server.protoServer import LandingServiceServer, create_response
...
class TestLandingServiceServer(unittest.TestCase):
    ...
    def test_talk_unary(self):
        ...
        method = self.test_server.invoke_unary_unary(
            method_descriptor=(
                landing_pb2.DESCRIPTOR.services_by_name[
                    "LandingService"
    ...
    def test_talk_server_streaming(self):
        ...
        # Collect responses
        responses = [method.take_response(), method.take_response()]
