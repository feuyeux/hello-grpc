...
class LandingServiceClient extends $grpc.Client {
  ...
  static final _$talkOneAnswerMore =
      $grpc.ClientMethod<$0.TalkRequest, $0.TalkResponse>(
          '/hello.LandingService/TalkOneAnswerMore',
          ($0.TalkRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.TalkResponse.fromBuffer(value));
  static final _$talkMoreAnswerOne =
      $grpc.ClientMethod<$0.TalkRequest, $0.TalkResponse>(
          '/hello.LandingService/TalkMoreAnswerOne',
          ($0.TalkRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.TalkResponse.fromBuffer(value));
  static final _$talkBidirectional =
      $grpc.ClientMethod<$0.TalkRequest, $0.TalkResponse>(
  ...
  $grpc.ResponseFuture<$0.TalkResponse> talk($0.TalkRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$talk, request, options: options);
  }

  $grpc.ResponseStream<$0.TalkResponse> talkOneAnswerMore(
      $0.TalkRequest request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$talkOneAnswerMore, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseFuture<$0.TalkResponse> talkMoreAnswerOne(
      $async.Stream<$0.TalkRequest> request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$talkMoreAnswerOne, request, options: options)
        .single;
  }

  $grpc.ResponseStream<$0.TalkResponse> talkBidirectional(
      $async.Stream<$0.TalkRequest> request,
      {$grpc.CallOptions? options}) {
...
abstract class LandingServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.TalkResponse> talk_Pre(
      $grpc.ServiceCall call, $async.Future<$0.TalkRequest> request) async {
    return talk(call, await request);
  }

  $async.Stream<$0.TalkResponse> talkOneAnswerMore_Pre(
      $grpc.ServiceCall call, $async.Future<$0.TalkRequest> request) async* {
    yield* talkOneAnswerMore(call, await request);
  }

  $async.Future<$0.TalkResponse> talk(
      $grpc.ServiceCall call, $0.TalkRequest request);
  $async.Stream<$0.TalkResponse> talkOneAnswerMore(
      $grpc.ServiceCall call, $0.TalkRequest request);
  $async.Future<$0.TalkResponse> talkMoreAnswerOne(
      $grpc.ServiceCall call, $async.Stream<$0.TalkRequest> request);
  $async.Stream<$0.TalkResponse> talkBidirectional(
      $grpc.ServiceCall call, $async.Stream<$0.TalkRequest> request);
}
