...
#ifdef _WIN32
const char cert[] = "C:\\var\\hello_grpc\\server_certs\\cert.pem";
const char certKey[] = "C:\\var\\hello_grpc\\server_certs\\private.key";
const char certChain[] = "C:\\var\\hello_grpc\\server_certs\\full_chain.pem";
const char rootCert[] = "C:\\var\\hello_grpc\\server_certs\\myssl_root.cer";
...
public:
    ...
    static void buildResult(const string &id, TalkResult *talkResult)
    {
