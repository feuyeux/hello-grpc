...
public class Constants {
  ...
  public static final Metadata.Key<String> x_b3_flags =
      Metadata.Key.of("x-b3-flags", Metadata.ASCII_STRING_MARSHALLER);
  public static final Metadata.Key<String> x_ot_span_context =
      Metadata.Key.of("x-ot-span-context", Metadata.ASCII_STRING_MARSHALLER);
  ...
  public static final Context.Key<String> context_x_ot_span_context =
      Context.key("x-ot-span-context");
