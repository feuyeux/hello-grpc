...
public protocol Org_Feuyeux_Grpc_LandingServiceClientInterceptorFactoryProtocol: GRPCSendable {
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
public protocol Org_Feuyeux_Grpc_LandingServiceAsyncProvider: CallHandlerProvider {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Org_Feuyeux_Grpc_LandingServiceServerInterceptorFactoryProtocol? { get }
  ...
  ///Server streaming RPC
  @Sendable func talkOneAnswerMore(
    request: Org_Feuyeux_Grpc_TalkRequest,
  ...
  public func handle(
    ...
    case "Talk":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Org_Feuyeux_Grpc_TalkResponse>(),
        interceptors: self.interceptors?.makeTalkInterceptors() ?? [],
        wrapping: self.talk(request:context:)
      )
    ...
    case "TalkOneAnswerMore":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Org_Feuyeux_Grpc_TalkResponse>(),
        interceptors: self.interceptors?.makeTalkOneAnswerMoreInterceptors() ?? [],
        wrapping: self.talkOneAnswerMore(request:responseStream:context:)
      )
    ...
    case "TalkMoreAnswerOne":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Org_Feuyeux_Grpc_TalkResponse>(),
        interceptors: self.interceptors?.makeTalkMoreAnswerOneInterceptors() ?? [],
        wrapping: self.talkMoreAnswerOne(requestStream:context:)
      )
    ...
    case "TalkBidirectional":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Org_Feuyeux_Grpc_TalkResponse>(),
        interceptors: self.interceptors?.makeTalkBidirectionalInterceptors() ?? [],
        wrapping: self.talkBidirectional(requestStream:responseStream:context:)
      )
...
public protocol Org_Feuyeux_Grpc_LandingServiceServerInterceptorFactoryProtocol {
