...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    try {
        ...
        configTitle.textContent = `gRPC Server Configuration --  ${platform} ${arch}`;
    } catch (error) {
