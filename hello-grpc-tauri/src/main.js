...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    // Configure mode selection based on platform capabilities
    if (webMode) {
    ...
    const systemInfo = webMode ? getWebPlatformInfo() : 'Tauri';
    ...
    /// 
    /// Orchestrates the execution of all gRPC operations based on the
    /// detected or selected mode (native vs web). Provides real-time
    /// feedback and formatted output matching Flutter's behavior.
    askBtn.addEventListener('click', async function () {
        ...
        const platformInfo = useWebMode
            ? 'Web Platform - Using HTTP simulation for gRPC'
            : 'Native Platform - Using direct gRPC';
